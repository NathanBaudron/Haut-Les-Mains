 ...
 * GÃ¨re l'injection HTML et l'interactivitÃ© globale du Header / Megamenu / Mobile Drawer / Footer.
 */

document.addEventListener("DOMContentLoaded", () => {
    // 1. DÃ©tecter le nom du fichier actuel pour le surlignage actif
    const path = window.location.pathname;
    const page = path.split("/").pop() || "index.html";

    // 2. DÃ©finition du code HTML pour le Header (Topbar + Header Desktop)
    const headerHTML = `
        <!-- Top Info Bar -->
        <div class="top-bar">
            <div class="container top-bar-content">
                <div class="top-bar-carousel" id="topBarCarousel">
                    <span class="carousel-item active"><strong>HÃ©bergement GRATUIT</strong> durant vos stages de formation !</span>
                    <span class="carousel-item"><strong>Repas du soir GRATUIT</strong> durant vos stages de formation !</span>
                    <span class="carousel-item"><strong>Mise Ã  disposition d'une voiture</strong> sur place !</span>
                    <span class="carousel-item">Transferts aÃ©roport ou TGV (Aix, Marseille, Nice - retour compris)</span>
                </div>
                <div class="top-bar-right">
                    <div class="top-bar-contact">
                        <a href="https://wa.me/33695288020" class="contact-link" target="_blank" rel="noopener noreferrer">
                            ...
                            <span>WhatsApp : 06 95 28 80 20</span>
                        </a>
                    </div>
                    <div class="lang-switcher">
                        <button class="lang-btn active" id="btn-lang-fr" aria-label="Langue FranÃ§aise">FR</button>
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu megamenu-5col">
                                <div class="submenu-group">
                                    <span>GÃ©nÃ©ralitÃ©s</span>
                                    <a href="stage-parapente-general.html">GÃ©nÃ©ralitÃ© Formation</a>
                                    <a href="controle-parapente-speed.html">ContrÃ´le Aile</a>
                                ...
                                <div class="submenu-column-container">
                                    <div class="submenu-group">
                                        ...
                                        <a href="autonomie-parapente.html">Autonomie DÃ©co AtÃ©ro</a>
                                        <a href="parapente-thermique.html">MontÃ©e en Thermique</a>
                                    ...
                                    <div class="submenu-group">
                                        ...
                                        <a href="progression-rapide-parapente.html">Progression AccÃ©lÃ©rÃ©e Parapente</a>
                                        <a href="progression-parapente-pib.html">Progression IndividualisÃ©e Biplace</a>
                                    </div>
                                </div>
                                <div class="submenu-group">
                                ...
                                <div class="submenu-group">
                                    <span>BaptÃªmes Biplace</span>
                                    <a href="bapteme-parapente.html">PrÃ©sentation & Tarifs</a>
                                    <a href="bapteme-parapente-generalite.html">GÃ©nÃ©ralitÃ© Biplace</a>
                        ...
                        <li class="dropdown">
                            <a href="hebergement.html" class="${[ 'gite.html', 'chambredhote.html', 'hebergement.html', 'maison.html', 'chambre.html', 'dormir.html' ].includes(page) ? 'active' : ''}">
                                HÃ©bergement <svg class="chevron" width="10" height="6" viewBox="0 0 10 6" fill="none"><path d="M1 1L5 5L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            </a>
                            <div class="dropdown-menu">
                                <a href="dormir.html">Descriptif HÃ©bergements</a>
                                <a href="gite.html">GÃ®te "Chez Paul et Vivo"</a>
                                <a href="chambredhote.html">Chambres d'HÃ´tes "Chez Coco"</a>
                                <a href="chambre.html">Le Dortoir "Chez Lili"</a>
                                <a href="maison.html">GÃ®te "Chez AngÃ©lique"</a>
                            </div>
                        </li>
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="site-parapente-general.html">GÃ©nÃ©ralitÃ©s</a>
                                <a href="parapente-barreme.html">Site de BarrÃªme</a>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="dirtech.html">StÃ©phane Henry</a>
                                <a href="meteo.html">MÃ©tÃ©o & Balises</a>
                                <a href="parapente-provence.html">Nous Rejoindre</a>
                                <a href="village-barreme.html">Le Village de BarrÃªme</a>
        ...
        <div class="mobile-nav-drawer" id="mobileDrawer">
            <div class="mobile-drawer-content">
                ...
                <div class="mobile-panel active" id="mobile-panel-main">
                    <nav class="mobile-nav">
                        <ul>
                            ...
                            <li><button class="mobile-panel-trigger" data-target="mobile-panel-hebergement">HÃ©bergement <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"></polyline></svg></button></li>
                ...
                <div class="mobile-panel" id="mobile-panel-parapente">
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            <li class="submenu-subtitle">GÃ©nÃ©ralitÃ©s</li>
                            <li><a href="stage-parapente-general.html">GÃ©nÃ©ralitÃ© Formation</a></li>
                            <li><a href="controle-parapente-speed.html">ContrÃ´le Aile</a></li>
                            ...
                            <li><a href="autonomie-parapente.html">Autonomie DÃ©co AtÃ©ro</a></li>
                            <li><a href="parapente-thermique.html">MontÃ©e en Thermique</a></li>
                            ...
                            <li><a href="progression-rapide-parapente.html">Progression AccÃ©lÃ©rÃ©e Parapente</a></li>
                            <li><a href="progression-parapente-pib.html">Progression IndividualisÃ©e Biplace</a></li>
                            ...
                            <li class="submenu-subtitle">BaptÃªmes Biplace</li>
                            <li><a href="bapteme-parapente.html">PrÃ©sentation & Tarifs</a></li>
                            <li><a href="bapteme-parapente-generalite.html">GÃ©nÃ©ralitÃ© Biplace</a></li>
                ...
                <div class="mobile-panel" id="mobile-panel-parakite">
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            <li><a href="parakite-general.html">GÃ©nÃ©ralitÃ©s ParaKite</a></li>
                            ...
                            <li><a href="parakite-controle.html">ContrÃ´le ParaKite</a></li>
                ...
                <div class="mobile-panel" id="mobile-panel-minivoile">
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            <li><a href="mini-voile-general.html">GÃ©nÃ©ralitÃ©s Mini-Voile</a></li>
                            ...
                            <li><a href="mini-voile-controle.html">ContrÃ´le Mini-Voile</a></li>
                ...
                <!-- Sub-panel: HÃ©bergement -->
                <div class="mobile-panel" id="mobile-panel-hebergement">
                    <button class="mobile-back-trigger"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"></polyline></svg> Retour</button>
                    <div class="mobile-panel-title">HÃ©bergement</div>
                    <nav class="mobile-nav">
                        <ul>
                            <li><a href="dormir.html">Descriptif HÃ©bergements</a></li>
                            <li><a href="gite.html">GÃ®te "Chez Paul et Vivo"</a></li>
                            <li><a href="chambredhote.html">Chambres d'HÃ´tes "Chez Coco"</a></li>
                            <li><a href="chambre.html">Le Dortoir "Chez Lili"</a></li>
                            <li><a href="maison.html">GÃ®te "Chez AngÃ©lique"</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="mobile-panel" id="mobile-panel-sites">
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            <li><a href="site-parapente-general.html">GÃ©nÃ©ralitÃ©s</a></li>
                            <li><a href="parapente-barreme.html">Site de BarrÃªme</a></li>
                ...
                <div class="mobile-panel" id="mobile-panel-infos">
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            <li><a href="dirtech.html">StÃ©phane Henry</a></li>
                            <li><a href="meteo.html">MÃ©tÃ©o & Balises</a></li>
                            <li><a href="parapente-provence.html">Nous Rejoindre</a></li>
                            <li><a href="village-barreme.html">Le Village de BarrÃªme</a></li>
    ...
    // 3. DÃ©finition du code HTML pour le Footer
    const footerHTML = `
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col footer-col-about">
                    ...
                    <p class="footer-desc">Licence et enseignement APPI-Fly. L'APPI propose une licence parapente basÃ©e sur une haute qualitÃ© de pratique et un systÃ¨me Ã©ducatif reconnu internationalement (Pilote, Tandem pilote, Instructeur).</p>
                    <p class="footer-legal-mention">Assurance : Code Partenaire Volpack RC AÃ©rienne <strong>EPHM04</strong>.</p>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="dormir.html">HÃ©bergements et Repas</a></li>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li><a href="controle-parapente-speed.html">ContrÃ´le de voile</a></li>
                        <li><a href="meteo.html">MÃ©tÃ©o & Balises</a></li>
                        <li><a href="parapente-utilitaires.html">Outils pÃ©dagogiques</a></li>
                ...
                <div class="footer-col">
                    ...
                    <address class="footer-address">
                        <p><strong>Ã‰cole de Vol Libre Haut les Mains</strong></p>
                        <p>Le village, 04330 BarrÃªme</p>
                        <p class="footer-tel">WhatsApp : <a href="https://wa.me/33695288020" target="_blank" rel="noopener noreferrer">06 95 28 80 20</a></p>
                        <p>StÃ©phane Henry, Moniteur & Ski Man</p>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Haut les Mains. Tous droits rÃ©servÃ©s. Modernisation graphique Ã©purÃ©e (sans Ã©mojis).</p>
                <div class="footer-bottom-links">
                    ...
                    <a href="mentions_legales.html">Mentions Lgales</a>
    ...
    if (footerPlaceholder) {
        // Envelopper le footer HTML dans une balise footer sÃ©mantique avec la classe main-footer
        footerPlaceholder.innerHTML = `<footer class="main-footer">${footerHTML}</footer>`;
    }

    // 5. Initialisation des comportements interactifs du Header injectÃ© (Mobile Drawer & Panels Glissants)
    const menuToggle = document.getElementById("menuToggle");
    const mobileDrawer = document.getElementById("mobileDrawer");

    if (menuToggle && mobileDrawer) {
        // RÃ©initialisation de l'Ã©tat du drawer mobile
        ...
        mobileNavLinks.forEach(link => {
            link.addEventListener("click", () => {
                ...
                setTimeout(resetMobileDrawer, 300); // RÃ©initialiser aprÃ¨s la transition
            });
        });
    ...
    // 6. Gestion du carrousel de la barre d'info en haut (si prÃ©sente)
    ...
    // Configuration des Ã©couteurs de clics sur les boutons avec rafraÃ®chissement diffÃ©rÃ© (Ã©vite les conflits d'Ã©criture de cookie)
    const btnFr = document.getElementById("btn-lang-fr");
    const btnEn = document.getElementById("btn-lang-en");
    if (btnFr && btnEn) {
    ...
    // Mettre en surbrillance le bouton actif dÃ¨s le chargement (lecture du stockage local)
    ...
    function injectGoogleTranslate() {
        // Ajout du conteneur cachÃ© requis
        ...
        // Callback global appelÃ© par l'API Google
